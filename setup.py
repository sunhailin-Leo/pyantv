...
__title__ = "pyantv"
__folder_title__ = "pyantv"
__description__ = "python visualization sdk for AntV"
__url__ = "https://github.com/sunhailin-Leo/pyantv"
__author_email__ = "shjkfld379978424@gmail.com"
__license__ = "MIT"

__requires__ = ["setuptools>=38.3", "jinja2>=2.11.3", "simplejson"]

__keywords__ = ["AntV", "charts", "plotting-tool"]
