...
c = (
    ...
    .set_data(
        data=opts.FetchDataOpts(
            ...
            transform=[opts.CustomDataTransformOpts(callback=JsCode(transform_func))],
        )
    )
    .set_encode(
    ...
    .set_scale(color_scale_opts=opts.ScaleBaseOpts(range_="#BAE7FF-#1890FF-#0050B3"))
    .set_global_options(
        ...
        axis_opts=False,
        legend_opts=False,
        tooltip_opts=opts.TooltipOpts(items=[opts.TooltipItemOpts(field="count")]),
