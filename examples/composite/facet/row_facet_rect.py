...
"""
行矩行分面
G2 文档: https://g2.antv.antgroup.com/examples/composition/facet/#row-facet-rect
"""
...
chart = (
    FacetRect()
    .set_data(data=data)
    .set_encode(y_field_name="city")
    .set_facet_rect_children(children=[bar.options])
    .set_global_options(title_opts=opts.TitleOpts(title="行矩行分面"))
)
chart.render("row_facet_rect.html")
