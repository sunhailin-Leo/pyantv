"""
带数据标签的聚合条形图
G2 文档: https://g2.antv.antgroup.com/examples/general/grouping/#aggregated-bar-with-label
"""
...
chart = (
    ...
    .set_global_options(
        title_opts=opts.TitleOpts(title="带数据标签的聚合条形图"),
        transform_opts=[opts.TransformDodgeXOpts()],
        coordinate_opts=opts.CoordinateTransposeOpts(),
        label_opts=[opts.LabelOpts(text_opts="value", font_size=10)],
    )
)
chart.render("aggregated_bar_with_label.html")
