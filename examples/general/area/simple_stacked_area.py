"""
简单堆叠面积图
G2 文档: https://g2.antv.antgroup.com/examples/general/area/#simple-stacked-area
"""
...
chart = (
    ...
    .set_global_options(
        title_opts=opts.TitleOpts(title="简单堆叠面积图"),
        transform_opts=[opts.TransformStackYOpts()]
    )
)
chart.render("simple_stacked_area.html")
