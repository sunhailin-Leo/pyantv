...
本文档面向人类开发者，提供了参与 pyantv 开发的完整指南。如果你是 AI agent，请参考仓库根目录下的 [CLAUDE.md](https://github.com/sunhailin-Leo/pyantv/blob/main/CLAUDE.md)。
...
1. **使用 PR 模板**：创建 PR 时会自动加载 [`.github/PULL_REQUEST_TEMPLATE.md`](https://github.com/sunhailin-Leo/pyantv/blob/main/.github/PULL_REQUEST_TEMPLATE.md)，请完整填写模板中的内容
...
如果你是第一次贡献，可以从 [Good First Issues](good-first-issues.md) 列表中选择适合的任务开始。这些任务通常难度较低，有明确的实现指引，是熟悉项目的好方式。
